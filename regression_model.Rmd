...
## Executive Summary
Motor Trend, a magazine about the automobile industry, are exploring the relationship between a set of variables and miles per gallon (MPG) (outcome). They want to determine:

1. “What is better for MPG? Automatic or manual transmission?”
2. "What is the quantifiable MPG difference between automatic and manual transmissions?"
